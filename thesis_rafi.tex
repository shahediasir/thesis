...
\include{chapters/pseudoUranium}

\include{chapters/u-mo-xe}
...
\appendix
\include{appen/atomicunits}
\include{appen/lihe}
\include{appen/opw}
\include{appen/paw}
%\include{appen/psfile}
\include{appen/fem_moose}
\include{appen/inputfiles}

\backmatter % mandatory; prepares for bibliography, glossary, index
%\nocite{*}
\bibliographystyle{apsrev4-1}
\bibliography{full,comp,umox,lihe}
