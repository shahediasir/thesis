...
\lstset{style=cpp}
\begin{lstlisting}
// this file was edited by Rafi for temperature dependent thermal conductivity
#include "TXenon.h"
...
\end{lstlisting}
\pagebreak
Material source code for U-10Mo properties.
\lstset{style=cpp}
\begin{lstlisting}
// this file was edited by Rafi January 24, 2017
// 
...
\section{ATOMPAW}
This is an input file for Atompaw to generate the PAW pseudopotential for electronic structure calculations on uranium.
\lstset{style=atpw}
\begin{lstlisting}
U 92
...
\pagebreak
\subsection{Supercell of \textgamma-Uranium}
...
\newpage
\subsection{\mbox{\textsc{QuantumEspresso}} with Python.}
